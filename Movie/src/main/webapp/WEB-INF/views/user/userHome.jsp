					...
					<div class="col-lg-6">
						<div class="fs-abt-content">
							...
							<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
								Eligendi veritatis eius, illum impedit id vitae!</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-blog">
								<div class="blog-content">
									<span>${movie.mtitle }</span> <span>개봉일 ${movie.opendate }</span>
								</div>
								<div class="blog-thumb">
									<img src="resources/movieposter/${movie.filename }" alt="">
									<a href="blog.html" class="read-more">바로 가기 <i
				...
				<tbody>
					<c:forEach items="${notice }" var="notice">
						<tr>
							<td>${notice.nocode }</td>
							<th scope="row"><a
								href="/support/notice/detail?artiNo=10472&amp;bbsNo=9"
								title="${notice.notitle } 상세보기"> ${notice.notitle } </a></th>
							<td>${notice.nodate }</td>
						</tr>
