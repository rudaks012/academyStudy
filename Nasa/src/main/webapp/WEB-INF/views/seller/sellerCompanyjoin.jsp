				...
				<div class="row d-flex justify-content-center align-items-center">
					<div>
							...
							<div class="row d-flex justify-content-center align-items-center">
								<div class="col-sm-8">
									<div class="form-group">
										대표자성명<input id="bname" class="form-control valid" type="text"
								...
								<div class="col-sm-8">
									<div class="form-group">
										사업자등록번호<div class="d-flex">
											<input id="bnumber" class="form-control valid" type="number"
												placeholder="숫자만 입력">
											<button type="button" id="bChk" class="genric-btn primary radius"
												style="float: right;" onclick="testbt()">확인</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group mt-3 d-flex justify-content-center align-items-center">
							<div>
								<button type="button"
									class="genric-btn primary-border e-large">이전</button>&nbsp;&nbsp;&nbsp;
					...
					<div>
						...
						<form class="form-contact contact_form" action="contact_process.php" method="post"
							...
							<div class="row d-flex justify-content-center align-items-center">
								...
								<div class="col-sm-8">
									<div class="form-group">
										이메일 인증<div class="d-flex">
											...
											<input type="button" value="확인" class="genric-btn primary radius"
												style="float: right;">
										</div>
									</div>
								</div>
								<div class="col-sm-8">
									<div class="form-group">
										비밀번호<input class="form-control valid" name="password" id="password"
								...
								<div class="col-sm-8">
									<div class="form-group">
										주소<div class="d-flex">
											...
											<input type="button" id="addressSearch" value="검색"
												class="genric-btn primary radius" style="float: right;">
										</div>
										<input class="form-control valid" id="addressDetail" type=""
					...
					<div>
						...
						<form class="form-contact contact_form" action="contact_process.php" method="post"
							...
							<div class="row d-flex justify-content-center align-items-center">
								<div class="col-12">
									<div class="form-group">
										닉네임<div class="d-flex">
											...
											<input type="button" value="검색" class="genric-btn primary radius"
												style="float: right;">
										</div>
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<textarea class="form-control w-100" cols="60" rows="9"
											placeholder="자기소개 메세지"></textarea>
									</div>
								</div>
							</div>
						</form>
										...
										<div class="d-flex" style="margin-top: 10px;">
											<div class="switch-wrap d-flex justify-content-between">
												<div class="confirm-radio">
													<input type="radio" id="confirm-radio1" name="fruit"
														checked="checked" value="졸업">
					...
					<div>
						...
						<div class="col-12" style="text-align: center;">
							<span style="font-size: 20px;">판매자 서비스 정보 수정은<br>
								<a href="#" style="color: #212529; text-decoration: underline;">마이페이지</a>에서
								가능합니다.</span>
							<br>
							<br>
							<br>
