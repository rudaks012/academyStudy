...
.profile-real-name, .profile-stat-count, .profile-edit-bttn {
	font-weight: 600;
}
...
@media screen and (max-width: 40rem) {
	...
	.profile-edit-bttn, .profile-bio, .profile-stats {
		flex-basis: 100%;
	}
	.profile-stats {
		order: 1;
...
@media ( max-width : 40rem) {
	...
	.profile-edit-bttn, .profile-stats, .profile-bio {
		grid-column: 1/-1;
	}
	.profile-user-settings, .profile-edit-bttn, .profile-settings-bttn,
			...
			<div class="row justify-content-center">
				<div class="profile">
					...
					<div class="profile-user-settings">
						...
						<button class="bttn profile-edit-bttn"
							style="height: 30px; font-size: 15px;">정보 수정</button>
					</div>
