					...
					<div>
						<div>
							...
							<div id="nickdiv" class="form-group">
								닉네임
								<input class="form-control valid" name="b_nickname" id="b_nickname"
							...
							<div id="pwdiv" class="form-group">
								비밀번호
								<input class="form-control valid" name="b_password" id="b_password" type="password"
							...
							<div id="phonediv" class="form-group">
								연락처
								<input class="form-control valid" name="b_tel" id="b_tel"
							...
							<div id="addressdiv" class="form-group">
								...
								<input disabled class="form-control valid" id="b_address" name="b_address"
									placeholder="주소">
								<input disabled class="form-control valid" id="b_detailaddress" name="b_detailaddress"
									placeholder="상세 주소">
							</div>
							<div class="d-flex">
