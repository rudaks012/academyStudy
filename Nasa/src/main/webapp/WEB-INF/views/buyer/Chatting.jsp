               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="count mb-35">
                        ...
                        <button type="button" data-toggle="modal" data-target="#payModal" id="payement"
                           class="w-btn-neon2" style="float: right; display: none;"
                           onclick="paymentconfirm();sercodecheck();promotioncheck();selrankcheck()">결제하기</button>
                        <button type="button" data-toggle="modal" data-target="#reportModal" id="Chatreport"
                           class="w-btn-neon2" style="float: right; display: none;">신고하기</button>
                     </div>
                  </div>
               </div>
               <!-- 채팅 창 -->
 ...
 -->
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
                  ...
                  <form id="dataForm" method="post" enctype="multipart/form-data">
                     <div class="form-group">
                        ...
                        <label><input type="radio" name="reportType" value="음란물" onclick="radiodisabled()">
                           음란물</label><br> <label><input type="radio" name="reportType" value="스팸/부적절한 광고"
                              onclick="radiodisabled()"> 스팸/부적절한 광고</label><br> <label><input type="radio"
                              name="reportType" value="혐오/잔인한 사진" onclick="radiodisabled()"> 혐오/잔인한 사진</label><br>
                        <div class="form-group">
                           <label><input type="radio" name="reportType" value="기타사유" onclick="radioactive()">
                              기타사유</label>
               ...
               <div class="modal-footer">
                  <a href="#" class="genric-btn danger radius" data-dismiss="modal" onclick="reportReview()">신고</a> <a
                     href="#" class="genric-btn primary radius" data-dismiss="modal" onclick="readiodisabled()">취소</a>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="modal-dialog" role="document" style="max-width: 400px;">
            <div class="modal-content">
               ...
               <form>
                  ...
                  <div class="modal-body">
                     <div style="">
                        <img src="assets/img/comment/comment_1.png"> <span id="paycheckId" style="display:inline-block;"></span>
                        <br>
                     ...
                     <table class="paytb">
                        ...
                        <tr>
                           ...
                           <td><input type="radio" name="paydate" value="ndate" id="ndate" checked>정해진 날짜가 없어요 <br />
                              <input type="radio" name="paydate" value="ydate" id="ydate">협의한
                        ...
                        <tr>
                           ...
                           <td id="coupontest">
                              ...
                              <input type="radio" name="coupon" value="coupon" id="couponrank"
                                 onclick="couponcheck()"><span id="couponspan"></span>
                              <!--여기서 체크-->
                           </td>
                        </tr>
                        <tr>
                     ...
                     <div class="br">
                        <span><input type="checkbox">개인정보수집 및 이용동의(필수)</span> <a style="float: right;"
                           data-toggle="modal" data-target="#useModal">보기</a>
                     </div>
               ...
               <div class="modal-footer">
                  <a href="#" class="genric-btn primary  radius powerbtn" data-toggle="modal" data-dismiss="modal"
                     onclick="chatpaymentOK()">결제</a> <a href="#" class="genric-btn primary radius powerbtn"
   ...
   <script>
      ...
      function enterRoom(obj) {
         ...
         var re_member = document.querySelector(".left").querySelector(".sender").getElementsByTagName("span")[0]
            .innerText;
      ...
      function connect() {
         // 웹소켓 주소
         var wsUri =
            "ws://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/websocket/echo.do";
      ...
      function promotioncheck() {
         ...
         console.log("프로모션", servicecode);
         $.ajax({
            url:"promotioncheck.do",
            type:"post",
            data:{
               promotioncheck:servicecode
            },
            dataType:"json",
            success:function (data) {
               console.log("프로모션 체크", data);
            }
         })
      ...
      function sercodecheck() {
         ...
         $.ajax({
            ...
            success: function (data) {
               ...
               var serviceid = document.getElementById("serviceid").append(data.ser_title);
