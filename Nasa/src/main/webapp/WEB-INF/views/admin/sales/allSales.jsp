...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-7 align-self-center">
			<div class="mb-3 ">
				<h6>
					<i class="fas fa-chart-line mr-1"></i>매출조회 <i
						class="fas fa-chevron-right mx-2"></i>카테고리별매출
				</h6>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	...
	<div class="row my-5">
		<div class="col-lg-12">
			<h5
				class="mt-3 p-3 text-white bg-dark d-flex justify-content-between"
				style="border-radius: 5px;">월별 매출 조회</h5>
			<div class="card">
				<div class="card-body">
					...
					<table
						class="mt-4 table table-hover table-bordered thead-light  text-center">
						<thead>
							<tr>
								<th></th>
	...
	<div class="row my-5">
		<div class="col-lg-12">
			<h5
				class="mt-3 p-3 text-white bg-dark d-flex justify-content-between"
				style="border-radius: 5px;">연별 매출 조회</h5>
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"></h4>
                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            data: [
                                21,19,25,20,23,26,25,13,15,15,31,1,2 //x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
